(function () {
    ...
    t = FG.Widgzard.render(conf, true, 'tony');

    console.debug(FG.Widgzard.getElements())
    
    // window.t = FG.engy.load('http://www.widgzard.dev/samples/js/load.js');
    /*FG.engy.get(conf).then(function (p, r) {
