    ...
    content: [{
        ...
        cb : function () {
            ...
            tpl.cb = function () {
                ...
                FG.events.on(next.node, 'click', function (e) {
                    FG.events.kill(e);
                    switchToNext();
                    setButtons();
                });
                FG.events.on(previous.node, 'click', function (e) {
                    FG.events.kill(e);
                    switchToPrevious();
                    setButtons();
                });

                FG.events.on(pollRoot.node, 'click', function (e) {
                    FG.events.kill(e);
                    var el = FG.events.eventTarget(e),
                        val = [], tmp, i = 0;
                ...
                FG.events.on(self.node, 'keydown', function (e) {
                    e.keyCode == 9 && FG.events.kill(e);
                });

                FG.events.on(self.node, 'submit', function () {
